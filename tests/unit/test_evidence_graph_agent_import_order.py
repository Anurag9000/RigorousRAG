...
assert legacy._evidence_graph_agent_tool_installed is True
""",
        """
import search_agent
...
assert names.count("list_evidence_graph_sets") == 1
assert names.count("search_evidence_graph") == 1
assert search_agent._evidence_graph_agent_tool_installed is True
""",
        """
import importlib
import search_agent_legacy as legacy
...
def test_graph_agent_installation_survives_import_orders(source: str) -> None:
