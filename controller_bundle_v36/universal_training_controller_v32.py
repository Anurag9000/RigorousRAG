#!/usr/bin/env python3
"""Universal controller v32: exhaustive full scientific-choice closure.

v32 preserves the complete v31 lifecycle, source-contract, exact-resume,
early-stopping, selector/config, registry/member, declared-combination and
scientific-ontology stack, then adds fail-closed accounting for the remaining
scientifically material choice families covered by
``universal_training_controller_scientific_ontology_v32``.
...
def main() -> int:
    # Build the complete vocabulary before repository inventory/closure starts.
