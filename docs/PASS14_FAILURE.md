...
...................F..................F.................                 [100%]
=================================== FAILURES ===================================
______ test_visual_entailment_passes_exact_registry_snapshot_to_renderer _______
...
tests/unit/test_integrity_extended.py:207: 
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 

self = <MagicMock name='_extract_figure_region' id='140017564336880'>
args = (b'immutable-pdf-snapshot', 'Figure 1'), kwargs = {}
...
E           AssertionError: Expected '_extract_figure_region' to be called once. Called 0 times.

/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/unittest/mock.py:960: AssertionError
__________________ test_reparse_chroma_component_is_rejected ___________________

monkeypatch = <_pytest.monkeypatch.MonkeyPatch object at 0x7f58612e9640>
tmp_path = PosixPath('/tmp/pytest-of-runner/pytest-0/test_reparse_chroma_component_0')
...
tests/unit/test_rag_public_boundaries.py:285: 
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 
tools/rag.py:365: in __init__
    persist_directory=_absolute_storage_path(persist_directory),
                      ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
tools/rag.py:291: in _absolute_storage_path
    _reject_redirecting_components(absolute)
tools/rag.py:48: in _reject_redirecting_components
    metadata = candidate.lstat()
               ^^^^^^^^^^^^^^^^^
_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ 

self = PosixPath('/tmp/pytest-of-runner/pytest-0/test_reparse_chroma_component_0/vectors')
...
E           AttributeError: module 'tools.rag_legacy' has no attribute '_WINDOWS_REPARSE_POINT'

tests/unit/test_rag_public_boundaries.py:277: AttributeError
=========================== short test summary info ============================
FAILED tests/unit/test_integrity_extended.py::test_visual_entailment_passes_exact_registry_snapshot_to_renderer - AssertionError: Expected '_extract_figure_region' to be called once. Called 0 times.
FAILED tests/unit/test_rag_public_boundaries.py::test_reparse_chroma_component_is_rejected - AttributeError: module 'tools.rag_legacy' has no attribute '_WINDOWS_REPARSE_POINT'
2 failed, 54 passed in 4.06s
