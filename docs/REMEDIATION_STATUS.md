...
| False redaction/privacy guarantee | Corrected and mitigated | Full text, OCR output, sections, titles, filenames, metadata, summaries, job-facing strings, CLI output, provider results, and scientific result mappings are masked. Documentation states masking is best effort. |
