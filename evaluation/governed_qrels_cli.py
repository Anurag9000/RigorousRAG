"""Strict config-only entry point for governed qrels parsing and persistence."""
...
from evaluation.governed_qrels import load_governed_qrels
...
def run_qrels_config(path: str | Path) -> Mapping[str, Any]:
    ...
    return {"receipt_path": raw["receipt_path"], "receipt_sha256": qrels.receipt.receipt_sha256, "pair_count": qrels.receipt.pair_count, "query_count": qrels.receipt.query_count, "document_count": qrels.receipt.document_count, "contract_sha256": qrels.contract_sha256}


def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Parse exact local qrels into a governed, restart-verifiable receipt")
