"""Installed production release operator v4.

Cohort and evaluator-bound evaluation construction reuse the v3 implementation. Qualification
and verification additionally enforce complete directional evaluator-policy coverage, so an
empty or selectively omitted threshold policy cannot cross the production release surface.
"""
