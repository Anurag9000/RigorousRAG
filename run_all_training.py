...
closed-world scientific catalog and invokes the current universal v26 bootstrap;
...
enabled with production paths/digests. v26 makes strong scientific registries,
...
def main() -> int:
    if not CONTROLLER.is_file():
        raise RuntimeError(f"Universal v26 controller bootstrap is missing: {CONTROLLER}")
