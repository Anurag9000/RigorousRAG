...
REPOSITORY="Anurag9000/RigorousRAG";SHA="a739ff9e31d9be7b5c9b0fe8d9bcfca6d75c846b";ROOT=Path(__file__).resolve().parent;CONTROLLER=ROOT/"tools"/"universal_training_controller_entry.py"
