...
closed-world scientific catalog and invokes the current universal v27 bootstrap;
...
enabled with production paths/digests. v27 makes strong scientific registries,
...
and additionally requires every repository-authored compatible scientific
combination to be represented together by a concrete job or authoritative recipe
iterator without inventing Cartesian products.
"""
...
def main() -> int:
    if not CONTROLLER.is_file():
        raise RuntimeError(f"Universal v27 controller bootstrap is missing: {CONTROLLER}")
