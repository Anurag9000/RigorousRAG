...
REPOSITORY="Anurag9000/RigorousRAG";SHA="ca636facd40bf1bfba4a7537a2899f71c54fd430";ROOT=Path(__file__).resolve().parent;CONTROLLER=ROOT/"tools"/"universal_training_controller_entry.py"
